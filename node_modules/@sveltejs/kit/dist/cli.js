 ...
 * @returns {string[]}
 */
function get_svelte_packages(cwd) {
...
const prog = sade('svelte-kit').version('1.0.0-next.150');
...
export { $, resolve_entry as a, posixify as b, copy_assets as c, deep_merge as d, copy as e, get_svelte_packages as g, logger as l, mkdirp as m, print_config_conflicts as p, rimraf as r };
