...
import { b as posixify, m as mkdirp } from '../cli.js';
import { g as globrex_1 } from './index4.js';
import os from 'os';
...
function globalyzer(pattern, opts = {}) {
    ...
    if (!isGlob) {
        base = path__default.dirname(pattern);
...
function get_assets_list(config) {
	 ...
	 */
	let assets = [];
	if (fs__default.existsSync(assets_dir)) {
		/**
		 * @type {string[]}
		 */
...
export { create_app as a, create_manifest_data as c, glob as g };
